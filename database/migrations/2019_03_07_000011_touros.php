...
class Touros extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('touros', function($tabela){
            $tabela->increments('id');
            $tabela->integer('codigo');
            $tabela->string('nome', 100)->nullable();
            $tabela->dateTime('data_compra');
            $tabela->smallInteger('emprestado');
            $tabela->string('emprestado_para')->nullable();
            $tabela->dateTime('data_emprestimo')->nullable();
        ...
        DB::table('touros')->insert(
            array(
                array('id' => 1, 'codigo' => 1, 'nome' => '1', 'data_compra' => '2020-01-01', 'emprestado' => 0, 'emprestado_para' => null, 'data_emprestimo' => null, 'fazendeiro_id' => '1', 'fazenda_id' => '1', 'piquete_id' => '1', 'lote_id'=> '1', 'raca_id'=> '1', 'causa_morte' => '', 'ativo' => 1)
            )
        );
    }
