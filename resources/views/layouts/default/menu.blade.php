...
<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="#" class="site_title"><img width="55" height="45" src="{{asset('imagens/logo_branco.png')}}"/>Gado</span></a>
        </div>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                <ul class="nav side-menu">
                    ...
                    <li>
                        <a><i class="fa fa-cogs"></i> Controle <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{ URL::to('/controle-lote') }}">Controle de lotes</a></li>
                        </ul>
                    </li>
                    <li>
                        <a><i class="fa fa-money"></i> Financeiro <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{ URL::to('/vendas') }}">Vendas</a></li>
<!--                            <li><a href="{{ URL::to('/vendas') }}">Vendas</a></li>-->
                            <!--<li><a href="{{ URL::to('/vendas') }}">Vendas</a></li>-->
                    ...
                    <li><a><i class="fa fa-bar-chart"></i> Relatórios <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{ URL::to('/relatorio-nascimentos') }}">Nascimentos</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
